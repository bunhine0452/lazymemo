...
- [x] 아이폰 TestFlight 업로드 + 내부 테스터로 설치 {#asc-testflight-ios}
- [x] 맥 TestFlight 업로드 + 설치해서 샌드박스 판이 실제로 뜨는지 {#asc-testflight-mac}
...
| 2026-09-14T13:08:09.029795+00:00 | #asc-testflight-ios | user | ~→x |  |  |
| 2026-09-14T13:08:11.126103+00:00 | #asc-testflight-mac | user | ~→x |  |  |
| 2026-09-15T13:40:16+09:00 | #asc-submit | claude-code | ☐→☐ | .oculpm/journal/20260915/Chores/1339_chore_release-readiness-tests-privacy-store-copy.md | 출시 점검 — ASC 빌드에 「1 photos」 있음, 커밋 뒤 재업로드·설명/심사 메모 갱신 뒤 제출 (READINESS 「출시 날 할 일」) |
<!-- oculpm:plan-log end -->
