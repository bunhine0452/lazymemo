...
enum NowSeen {
    ...
    static func load(defaults: UserDefaults = .standard) -> [ULID: Date] {
    ...
    static func save(_ seen: [ULID: Date], now: Date = Date(), calendar: Calendar = .current, defaults: UserDefaults = .standard) {
