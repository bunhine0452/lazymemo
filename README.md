...
>
> [소개 페이지](https://bunhine0452.github.io/lazymemo/ko/) ([English](https://bunhine0452.github.io/lazymemo/)) · [릴리스](https://github.com/bunhine0452/lazymemo/releases/latest)
...
**앱이 스스로 바꾼다.** 메뉴 → 「새 판 0.2.0 으로 바꾸기」를 누르면 받아서 갈아 끼우고 다시 연다. 화면에서 보이는 것은 앱이 잠깐 닫혔다 뜨는 것뿐이다.

*Homebrew* 로 깔았다면 앱이 손대지 않는다 — 그러면 brew 의 장부가 어긋나 다음 `brew upgrade` 가 깨진다. 대신 메뉴가 새 판이 있다고 적고, 누르면 `brew upgrade --cask lazymemo` 를 클립보드에 넣어 준다.
...
| 새 판이 나왔는지 물어보기 | 주소 하나 (판 번호도 안 보낸다) | 기본 켜짐 · 설정에서 끌 수 있다 |
